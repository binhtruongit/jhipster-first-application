...
@RestController
@RequestMapping("/api/jhipster-first-app-kafka")
public class JhipsterFirstAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterFirstAppKafkaResource.class);
    ...
    public JhipsterFirstAppKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
